            ...
            >
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    >
                        ...
                        <a
                            href={`${siteConfig.social.whatsapp}?text=${encodeURIComponent('Hi! I am interested in getting a quote for supermarket racks. Please share more details.')}`}
                            target="_blank"
                        ...
                        >
                            ...
                            Get Quote for Supermarket Racks
                        </a>
                    </motion.div>
